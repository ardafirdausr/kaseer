...
func InitRouter() http.Handler {
	...
	orderRouter.HandleFunc("/total", GetTotalOrdersData).Methods("GET")
	orderRouter.HandleFunc("/latest-earning", GetLatestEarningData).Methods("GET")
	orderRouter.HandleFunc("/annual-earning", GetAnnualEarningData).Methods("GET")
	...
	productRouter.HandleFunc("/bestseller", GetBestSellerProductsData).Methods("GET")
